...
//! TODO: 路由例子
let loadPageExample = () => import(/* webpackChunkName: "stylistic.pageTemplate" */'components/template/page/page.vue')
let loadJavascript = () => import(/* webpackChunkName: "stylistic.javascript" */'../javascript/index.vue')
/* @init<%
...
export const routes = [
  ...
  {
    path: '/stylistic/javascript',
    name: 'StylisticJavascript',
    component: loadJavascript,
    meta: {
      module: 'stylistic',
      loginAuth: false,
      bgClass: '',
