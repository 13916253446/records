...
//! TODO: 路由例子
let loadPageExample = () => import(/* webpackChunkName: "quickKeyboard.pageTemplate" */'components/template/page/page.vue')
let loadChrome = () => import(/* webpackChunkName: "quickKeyboard.chrome" */'../chrome/index.vue')
/* @init<%
...
export const routes = [
  {
    //! 模块/组件名字
    path: '/quickKeyboard/pageTemplate',
    //! 如果使用keepAlive这个name必须和组件内部的name相同，要不然页面缓存无效
    name: 'pageQuickKeyboardTemplate',
    //! 路由懒加载
    component: loadPageExample,
    meta: {
      //? 模块标识 (必传，否则钩子进不来)
      module: 'quickKeyboard',
  ...
  {
    path: '/quickKeyboard/chrome',
    name: 'QuickKeyboardChrome',
    component: loadChrome,
    meta: {
      module: 'quickKeyboard',
      loginAuth: false,
      bgClass: '',
